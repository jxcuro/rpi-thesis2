# CODE 3.0.24 - AI Metal Classifier GUI with Gated Automation
...
# Version: 3.0.24 - MODIFIED: Updated SCALER_PARAMS with new values from training script.
#                  -           This ensures the new magnetism and resistivity models
#                  -           process live sensor data correctly.
...
# NOTE: These values are derived from the training script and are crucial
#       for the sensor models to work correctly.
SCALER_PARAMS = {
    'magnetism': {
        'mean': [5.5399],
        'scale': [11.8679]
