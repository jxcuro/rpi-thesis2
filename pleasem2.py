...
# ### NEW ### - Noise gate threshold for magnetism sensor
...
def capture_and_classify():
    ...
    if avg_v_capture is not None and abs(SENSITIVITY_V_PER_MILLITESLA) > 1e-9:
        ...
        # ### START MODIFICATION: Noise Gate ###
        # If the reading is below the threshold, treat it as zero to ignore sensor noise.
        # This ensures consistency with the live view and prevents noise from affecting the AI.
    ...
    if hall_sensor:
        ...
        if avg_v is not None:
            try:
                ...
                # ### START MODIFICATION: Noise Gate ###
                # If the absolute reading is below the threshold, treat it as zero to ignore sensor noise.
