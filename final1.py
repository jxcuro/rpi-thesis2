...
MAGNETIC_WEIGHTS = {
    'visual': 0.6,
    'magnetism': 0.4,  # Trust the magnetism model completely
    'resistivity': 0.0
}

# Weights to use WHEN an object is NOT detected as magnetic
NON_MAGNETIC_WEIGHTS = {
    'visual': 0.65,     # Visual model is the primary classifier
    'magnetism': 0.0,  # Ignore the magnetism model's opinion on non-magnetic types
    'resistivity': 0.35 # Resistivity is a strong tie-breaker between visual similarities
}
