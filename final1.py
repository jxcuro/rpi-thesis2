...
MAGNETISM_THRESHOLD_mT = 1.5  # Defines the cutoff for what is considered "magnetic" (in milliTesla)

# Weights to use WHEN an object IS detected as magnetic
MAGNETIC_WEIGHTS = {
    'visual': 0.0,
    'magnetism': 1.0,  # Trust the magnetism model completely
    'resistivity': 0.0
}

# Weights to use WHEN an object is NOT detected as magnetic
NON_MAGNETIC_WEIGHTS = {
    'visual': 0.7,     # Visual model is the primary classifier
